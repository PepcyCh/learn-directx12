...
class D3DAppTexture : public D3DApp {
  public:
    D3DAppTexture(HINSTANCE h_inst) : D3DApp(h_inst) {}
    ~D3DAppTexture() {
        if (p_device != nullptr) {
            FlushCommandQueue();
        }
  ...
  private:
    ...
    void BuildShaderAndInputLayout() {
        ...
        shaders["standard_vs"] = D3DUtil::CompileShader(src_path + L"ch09_texture/shaders/P3N3U2_default.hlsl",
            nullptr, "VS", "vs_5_1");
        shaders["opaque_ps"] = D3DUtil::CompileShader(src_path + L"ch09_texture/shaders/P3N3U2_default.hlsl",
            nullptr, "PS", "ps_5_1");
    ...
    void BuildRenderItems() {
        ...
        crate_ritem->mat = materials["crate"].get();
        ...
        ritem_layer[(size_t) RenderLayor::Opaque].push_back(crate_ritem.get());
